...
def contact(request):
    ...
    if request.method == "POST":
        ...
        contact.save()
        thank = True
    return render(request, 'rent/contact.html', {'thank': thank})
...
def productView(request, myid):
    ...
    return render(request, 'rent/prodView.html', {'product': product[0]})
...
def checkout(request):
    if request.method == "POST":
        ...
        thank = True
        id = order.order_id
        return render(request, 'rent/checkout.html', {'thank': thank, 'id': id})
